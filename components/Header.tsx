    ...
    <header className="sticky top-0 z-50 bg-ink text-white shadow-soft">
      <div className="mx-auto flex h-20 max-w-6xl items-center justify-between gap-6 px-4 sm:px-6">
        ...
        <div className="flex items-center gap-3">
          <a
            href={site.phoneHref}
            className="hidden items-center gap-2 text-base font-semibold text-white hover:text-stone-light md:inline-flex"
          >
          ...
          <a
            ...
            className="rounded-full border border-white/30 p-2.5 text-white md:hidden"
          >
